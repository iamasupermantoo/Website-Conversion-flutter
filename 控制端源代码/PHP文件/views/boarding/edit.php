...
$row = $boarding->getById($id);
if ($row == null) {
  echo '<script> window.location.href = "index.php?page=boarding"; </script>';
}
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">编辑引导画面</h1>
    <ol class="breadcrumb float-sm-right">
      ...
      <li class="breadcrumb-item active">编辑引导画面</li>
    </ol>
  </div>
  ...
  <div>
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">编辑引导画面</h6>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-xl-6 col-md-6 mb-4">
                ...
                <input type="description" class="form-control" id="description" name="description" placeholder="输入描述" value="<?= $row["description"] ?>" required>
              </div>
              ...
              <div class="form-group col-xl-6 col-md-6 mb-4">
                <img src="../images/boarding/<?= $row["image"] ?>?<?= time() ?>" style="width:200px" id="thumb_img" class="img-thumbnail">
              </div>
