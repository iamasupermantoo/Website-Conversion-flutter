<?php
include "../controllers/splash.php";
$splash = new Splash();
$s = $splash->getFirst();
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="enable_logo">显示logo图标</label>
								...
								<div class="form-group">
									<label for="enable_img">显示图片启动画面</label>
									<div class="custom-control custom-switch">
							...
							<div class="col-md-6">
                                ...
                                border-bottom-style: solid;">
									...
									<div id="preview_logo" style=" 
 									...
 									">
										<img 
										src="../images/splash/<?= $s["logo_splash"] ?>?<?= time() ?>" 
										style="width: 80px;"
										id="preview_img_logo" 
										/>
									</div>
									<div id="preview_splash" style="  
 									...
 									">
										<img src="../images/splash/<?= $s["img_splash"] ?>?<?= time() ?>" 
										style="
									        height:100%; 
											width: 100%;
										"
