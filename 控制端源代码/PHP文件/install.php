                    ...
                    <div class="card-body">
                        ...
                        if (@$_POST) {
                            ...
                            curl_setopt_array($curl, array(
                                CURLOPT_URL => "https://license.nulljungle.com/flyweb/",
                        ...
                        ?>
                        <div>
                            <h4 class="mb-3">FlyWeb v2.0.1</h4>
                            <form method="post" id="form_1" name="form_1" class="needs-validation" novalidate data-toggle="validator">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="purchase_code" name="purchase_code" placeholder="Purchase code" value="<?=base64_decode('TnVsbEp1bmdsZQ==')?>" required>
