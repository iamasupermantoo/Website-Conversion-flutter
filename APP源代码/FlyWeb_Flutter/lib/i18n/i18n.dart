...
class I18n implements WidgetsLocalizations {
  ...
  String get share => "分享程序";

  String get about => "关于我们";

  String get rate => "评价我们";

  String get update => "更新APP";

  String get notification => "Notification";

  String get languages => "语言设置";

  String get appLang => "App语言";

  String get descLang => "选择APP语言";

  String get whoops => "错误!";
  ...
  String get sureCloseApp => "你确定要退出应用程序吗 ?";
  ...
  String get darkMode => "夜晚模式";

  String get lightMode => "白天模式";
